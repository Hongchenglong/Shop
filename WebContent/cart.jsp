		...
		<div class="wrapper clearfix">
			<div class="clearfix" id="top">
				...
				<div class="fr clearfix" id="top1">
					<p class="fl">
						<a href="login.html" id="login">登录</a><a href="reg.html" id="reg">注册</a>
					</p>
		...
		<div class="site">
			<p class=" wrapper clearfix">
				<span class="fl">购物车</span><img class="top"
					src="img/temp/cartTop01.png"><a href="indexselect" class="fr">继续购物&gt;</a>
			</p>
		</div>
		<!-----------------table------------------->
		<div class="table wrapper">
			...
			<c:forEach var="rs" items="${requestScope.shoplist }">
				<div class="th">
							...
							<dl class="clearfix">
								<dt class="fl">
									<img width="120" height="120"
										src="images/product/${rs.cart_p_filename }">
								</dt>
								<dd class="fl">
									<p>${rs.cart_p_name }</p>
									<p>图书分类</p>
					...
					<div class="price">
						<a class="del" datasrc="${rs.cart_id }" href="#">删除</a>
					</div>
				</div>
			</c:forEach>
		...
		<div class="proCon clearfix">
			...
			<div class="fl">
				...
				<div class="changeBtn clearfix">
					<a href="#2" class="fl"><p class="buy">确认</p></a><a href="#2"
						class="fr"><p class="cart">取消</p></a>
				</div>
			</div>
		</div>
	</div>
