	...
	<div class="crumb-wrap">
		<div class="crumb-list">
			...
			<span class="crumb-step">&gt;</span><a class="crumb-name"
				href="/Shop/manage/admin_productselect">图书管理</a>
				<span class="crumb-step">&gt;</span><span>新增图书</span>
		</div>
	</div>
	<div class="result-wrap">
		<div class="result-content">
			<!-- do user add -->
			<form action="/Shop/manage/admin_doproductadd" method="POST" id="myform"
				...
				<table class="insert-tab" width="100%">
					...
					<tr>
						...
						<tr>
							...
							<td><select class="common-text required" id="title" name="parentId">
							
									<c:forEach var="f" items="${flist}">
									<option value="${f.CATE_ID}" selected="selected" disabled="disabled"> |-${f.CATE_NAME}</option>
						...
						<tr>
							...
							<td><input class="common-text required" id="title"
								name="photo" size="50" value="" type="file"></td>
						</tr><tr>
							<th><i class="require-red">*</i>图书价格：</th>
							<td><input class="common-text required" id="title"
								name="productPrice" size="50" value="" type="text"></td>
						</tr><tr>
							<th><i class="require-red">*</i>图书介绍：</th>
							<td><input class="common-text required" id="title"
								name="productDesc" size="50" value="" type="text"></td>
						</tr><tr>
							<th><i class="require-red">*</i>图书库存：</th>
							<td><input class="common-text required" id="title"
								name="productStock" size="50" value="" type="text"></td>
						</tr>
						<tr>
							<th></th>
