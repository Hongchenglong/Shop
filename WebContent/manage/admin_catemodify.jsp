...
<div class="main-wrap">
	...
	<div class="crumb-wrap">
		<div class="crumb-list">
			...
			<span class="crumb-step">&gt;</span><a class="crumb-name" href="#">分类管理</a><span
	...
	<div class="result-wrap">
		<div class="result-content">
			<!-- do user add -->
			<form action="/Shop/manage/admin_docateupdate" method="POST"
					...
					<tbody>
						...
						<tr>
							...
							<td><input class="common-text required" id="title"
								name="className" size="50" value="${c.CATE_NAME}" type="text"></td>
						</tr>
						<tr>
							<th></th>
